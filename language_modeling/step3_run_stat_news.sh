...
#root_dir="response_cnn_dm_news"
for root_dir in "response_news" "response_cnn_dm_news"
do
...
#    --output_root_dir "stat_news_app_ctrlgen_multi_constraints"
    ...
    do
      python ../uncertainty_quantification/stat_computations_from_entropy_profile.py \
        ...
        --min_example_per_position 5 \
        --smoothing_factor ${smoothing_factor} \
        --output_root_dir "stat_news_app_ctrlgen_multi_constraints_maxlen_${maxlen}"
    done
  done
done
