...
#root_dir="response_news"
#root_dir="response_random_strings"
root_dir="response_just_eval_instruct_nudging"
...
#  --piecewise_ebf \
#  --output_root_dir "stat_news_app_ctrlgen_multi_constraints"
...
do
  python ../uncertainty_quantification/stat_computations_from_entropy_profile.py \
    ...
    --output_root_dir "stat_just_eval_instruct_nudging_app_ctrlgen_multi_constraints"
  for maxlen in 5 50
  do
    python ../uncertainty_quantification/stat_computations_from_entropy_profile.py \
      --ckpt_dir ${ckpt_dir} \
      ...
      --maxlen ${maxlen} \
      --smoothing_factor ${smoothing_factor} \
      --output_root_dir "stat_just_eval_instruct_nudging_app_ctrlgen_multi_constraints_maxlen_${maxlen}"
  done
done
